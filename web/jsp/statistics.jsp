                    ...
                    <div class="col-xl-3 col-lg-6 col-12">
                        <div class="card">
                            <div class="card-body">
                                <div class="media d-flex">
                                    <div class="align-self-center">
                                        <i class="fa fa-pencil-square-o icon-large float-left" style="color: #006db6;">
                                        </i>
                                    </div>
                                    <div class="media-body text-right">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="media d-flex">
                                    ...
                                    <div class="media-body text-right">
                                        <h3 class="text-stat">${totalMembers}</h3>
                    ...
                    <div class="col-xl-3 col-lg-6 col-12">
                        <div class="card">
                            <div class="card-body">
                                <div class="media d-flex">
                                    <div class="align-self-center">
                                        <i class="fa fa-calendar icon-large float-left" style="color: #006db6;">
                                        </i>
                                    </div>
                                    <div class="media-body text-right">
